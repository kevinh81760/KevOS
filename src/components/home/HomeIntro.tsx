...
export default function HomeIntro() {
  return (
    <section className="min-h-[70vh] flex items-center justify-center px-6 pt-[var(--spacing-hero-intro)]">
      <ScrollFadeInOut 
        fadeInStart={0.2} 
        fadeInEnd={0.4} 
        fadeOutStart={0.6} 
      ...
      >
        <p className="text-zinc-100 text-2xl leading-loose tracking-wide font-medium mb-[var(--spacing-intro-mb)]" style={{ fontFamily: 'Akzidenz-Grotesk, Helvetica Neue, sans-serif' }}>
